...
from pycel.excelcompiler import build_ast, shunting_yard, ExcelCompiler
...
test_data = [
    ...
    },
    {
        ...
        "python_code": "(xsum((123+xsum(456))+((45 if 45 is not None else float('inf'))<6))+456)+789"
    },
    {
    ...
    },
    {
        ...
        "python_code": "(0 if eval_cell(\"R13C3\")>(date(2002,1,6) if date(2002,1,6) is not None else float('inf')) else (0 if iserror(eval_cell(\"R[41]C[2]\")) else (0 if eval_cell(\"R13C3\")>=(eval_cell(\"R[41]C[2]\") if eval_cell(\"R[41]C[2]\") is not None else float('inf')) else (eval_cell(\"R53C3\") if all([eval_cell(\"R[23]C[11]\")>=(55 if 55 is not None else float('inf')),eval_cell(\"R[24]C[11]\")>=(20 if 20 is not None else float('inf'))]) else 0))))"
    },
    {
        ...
        "python_code": "(eval_cell(\"R[25]C[42]\") if eval_cell(\"R[39]C[11]\")>(65 if 65 is not None else float('inf')) else xround((eval_cell(\"R[11]C[11]\")*(eval_cell(\"R[44]C[11]\") if any([all([eval_cell(\"R[39]C[11]\")>=(55 if 55 is not None else float('inf')),eval_cell(\"R[40]C[11]\")>=(20 if 20 is not None else float('inf'))]),all([eval_cell(\"R[40]C[11]\")>=(20 if 20 is not None else float('inf')),eval_cell(\"R11C3\")==\"YES\"])]) else eval_cell(\"R[43]C[11]\")))+(eval_cell(\"R[14]C[11]\")*(eval_cell(\"R[45]C[11]\") if any([all([eval_cell(\"R[39]C[11]\")>=(55 if 55 is not None else float('inf')),eval_cell(\"R[40]C[11]\")>=(20 if 20 is not None else float('inf'))]),all([eval_cell(\"R[40]C[11]\")>=(20 if 20 is not None else float('inf')),eval_cell(\"R11C3\")==\"YES\"])]) else eval_cell(\"R[43]C[11]\"))),0))"
    },
    {
    ...
    },
    {
        ...
        "python_code": "linest(b32:(index(eval_range(\"B32:B119\"),match(0,(eval_range(\"B32:B\") if eval_range(\"B32:B\") is not None else float('inf'))<6119,-1),1)),f32:(index(eval_range(\"B32:F119\"),match(0,eval_range(\"B32:B119\"),-1),5)),degree=-1)[-2]"
    }
]
...
def dump_parse():
    for test_case in test_data:
        ...
        parsed = shunting_yard(test_case['formula'])
