...
function_info = (
    ...
    FunctionInfo('FIND, FINDBs', 'Text', '', 'find-findb-functions-c7912941-af2a-4bdf-a553-d0d89b0a0628'),
    ...
    FunctionInfo('LEFT, LEFTBs', 'Text', '', 'left-leftb-functions-9203d2d2-7960-479b-84c6-1ea52b99640c'),
    FunctionInfo('LEN, LENBs', 'Text', '', 'len-lenb-functions-29236f94-cedc-429d-affd-b5e33d2c67cb'),
    ...
    FunctionInfo('MID, MIDBs', 'Text', '', 'mid-midb-functions-d5f9e25c-d7d6-472e-b568-4ecb12433028'),
    ...
    FunctionInfo('REPLACE, REPLACEBs', 'Text', '', 'replace-replaceb-functions-8d799074-2425-4a8a-84bc-82472868878a'),
    FunctionInfo('REPT', 'Text', '', 'rept-function-04c4d778-e712-43b4-9c15-d656582bb061'),
    FunctionInfo('RIGHT, RIGHTBs', 'Text', '', 'right-rightb-functions-240267ee-9afa-4639-a02b-f19e1786cf2f'),
    ...
    FunctionInfo('SEARCH, SEARCHBs', 'Text', '', 'search-searchb-functions-9ab04538-0e55-4719-a72e-b6f54513b495'),
